...
import com.snipe.let.admin.constant.StatusCode;
import com.snipe.let.admin.response.ErrorObject;
...
public class CommonUtils implements Constants {
	...
	public static ErrorObject getErrorResponse(String title, String message) {
